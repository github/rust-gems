...
- [`casefold`](crates/casefold): a compact (~1.7 KB) Unicode simple case-folding table, plus a decode-free bulk `simple_fold` that folds UTF-8 with little-endian byte arithmetic.
